...
if ( ! class_exists( 'Give' ) ) :
	...
	final class Give {
		...
		public function init() {
			...
			$this->donor_meta             = Give_DB_Donor_Meta::get_instance();
			$this->tooltips               = new Give_Tooltips();
			$this->notices                = new Give_Notices();
			$this->payment_meta           = Give_DB_Payment_Meta::get_instance();
			$this->log_db                 = new Give_DB_Logs();
			$this->logmeta_db             = Give_DB_Log_Meta::get_instance();
			$this->logs                   = new Give_Logging();
			$this->form_meta              = Give_DB_Form_Meta::get_instance();
